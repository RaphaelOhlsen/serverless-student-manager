...
class CognitoIdentityEvidence(StrEnum):
    ...
    ALIAS_ERROR_READBACK = "ALIAS_ERROR_READBACK"
    AMBIGUOUS_CREATE_READBACK = "AMBIGUOUS_CREATE_READBACK"


class CognitoReconciliationReason(StrEnum):
    IDENTITY_INCOMPATIBLE = "COGNITO_IDENTITY_INCOMPATIBLE"
    CREATE_RESULT_UNCERTAIN = "COGNITO_CREATE_RESULT_UNCERTAIN"
    ALIAS_CONFLICT = "COGNITO_ALIAS_CONFLICT"
