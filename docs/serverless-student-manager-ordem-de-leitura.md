...
32. `architecture/architecture-overview.md`
33. `architecture/data-model.md`
34. `architecture/security.md`
35. `architecture/deployment-and-cicd.md`
36. `architecture/observability.md`
37. `architecture/diagrams.md`
